...
class FarmersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create farmer" do
    assert_difference('Farmer.count') do
      post farmers_url, params: { farmer: { address: @farmer.address, farm_name: @farmer.farm_name, first_name: @farmer.first_name, last_name: @farmer.last_name, state: @farmer.state } }
    end
  ...
  test "should update farmer" do
    patch farmer_url(@farmer), params: { farmer: { address: @farmer.address, farm_name: @farmer.farm_name, first_name: @farmer.first_name, last_name: @farmer.last_name, state: @farmer.state } }
